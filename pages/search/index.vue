<template>
      ...
      <div class="flex justify-center items-center text-center ">
        <div class="w-full self-center px-4 lg:w-1/2 mb-10">
          ...
          <input
              ...
              />
              <button
                class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-r-md ml-2"
  ...
  <section id="card" class="mb-30 pb-35">
    <div class="container">
      ...
      <div class="text-center mb-10" v-show="datas == undefined">
        <p class="text-center text-red-500">Keyword Kurang Spesifik, contoh keyword benar: "Avenger", "Harry"</p>
      </div>
